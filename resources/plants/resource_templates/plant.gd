...
@export_group("Growth")
@export var min_growth: float = -100.0
@export var max_growth: float = 100.0
@export var growth_speed_per_sec: float = 1
@export var growth_stages: Array = [-66.7, -33.3]
@export var low_health: float = 20
@export var growth_loss_per_damage = 1
...
func grow(plant: Node2D, delta: float):
	plant.growth += growth_speed_per_sec*delta
